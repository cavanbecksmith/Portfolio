...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13)(module), __webpack_require__(4)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TimelineLite_js__ = __webpack_require__(3);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_3__TweenMax_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__TimelineLite_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_2__TimelineMax_js__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_9__EasePack_js__["h"]; });
...
__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["e" /* _gsScope */]._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function () {
	...
	_DEG2RAD = Math.PI / 180,
	    ...
	    _forcePT = {},
	    _dummyElement = { style: {} },
	    _doc = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["e" /* _gsScope */].document || { createElement: function () {
...
__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["e" /* _gsScope */]._gsDefine("easing.Back", ["easing.Ease"], function () {
	...
	var w = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["e" /* _gsScope */].GreenSockGlobals || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["e" /* _gsScope */],
	    ...
	    _easeReg = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["b" /* Ease */].register || function () {},
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_slide_1__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_slide_2__ = __webpack_require__(18);
...
var App = {
	...
	previousSlide(thisSlide, nextSlide, lastSlide) {
		...
		var window_w = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).width();
		var window_h = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).height();

		var offset = 200;
		var tl = new __WEBPACK_IMPORTED_MODULE_1_gsap__["b" /* TimelineLite */]();
		var scale = 0.75;
		var time = 0.25;
	...
	events: function () {
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('div.next').on('click', function () {

			var $this = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent();
			var thisID = Number($this.attr('data-id'));
			var next = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide')[thisID + 1];
			var lastSlide;

			if (thisID + 1 == __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide').length) {
				next = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide')[0];
				App.currentSlide = 0;
				lastSlide = true;
			} else {
				lastSlide = false;
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('div.previous').on('click', function () {

			var prevID = Number(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().attr('data-id')) - 1;
			var $this = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent();
			var next = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide')[prevID];
			var lastSlide;

			if (prevID === -1) {
				App.currentSlide = App.slideLen;
				next = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide')[__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide').length - 1];
	...
	hideSlides() {
		...
		App.slideLen = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide').length;

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide').each(function (i) {

			var id = i;

			if (i != App.currentSlide) {
				__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).css({ 'z-index': '-1', left: window_w + offset + 'px' });
			}

			__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('data-id', id);
		});
	},
	createArrows() {

		var next = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.next');
		var previous = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.previous');

		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.slide').each(function () {
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).append(next.clone());
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).append(previous.clone());
			App.fadeIn(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.next'));
			App.fadeIn(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.previous'));
		});
	},
	fadeIn(el) {
		__WEBPACK_IMPORTED_MODULE_1_gsap__["d" /* TweenMax */].to(el, 1, { opacity: 1, display: 'inline-block' });
	},
	disableScroll() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite_js__ = __webpack_require__(3);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_typed_js__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Game_game__ = __webpack_require__(19);



/* harmony default export */ __webpack_exports__["a"] = ({
	game: new __WEBPACK_IMPORTED_MODULE_1__Game_game__["a" /* Game */](__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.Slide2')),
	blur: { a: 5 },
	init() {
		this.events();
	},
	...
	events() {
		var $this = this;
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').on("keyup", function (event) {
			$this.game.still();
		});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_granim__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Flame__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Enemy__ = __webpack_require__(53);
...
var inlineSVG = __webpack_require__(54);
...
class Game {
	...
	constructor(container) {
		...
		this.boundary = {
			min: 0,
			max: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).width()
		};
		...
		this.gradient = new __WEBPACK_IMPORTED_MODULE_2_granim___default.a({
			element: '#GRADIENT',
			...
			states: {
				"default-state": {
					gradients: [['#90dffe', '#38a3d1']],
					loop: false
				},
				"dark": {
					gradients: [['#1e528e', '#728a7c']],
					loop: false
				},
				"darker": {
					gradients: [['#00000c', '#00000d']],
					loop: false
				}
			}
		});
	...
	create() {
		...
		rkt = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(rkt).attr('class', 'INLINE rocket').css({ 'width': $this.width, 'height': $this.height });
		var rktContainer = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div></div>').attr({ 'class': 'SHIP' }).css({ 'width': $this.width, 'height': $this.height, 'position': 'absolute', 'left': '20%' });

		var flameCont = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<canvas id="flame"></canvas>').css({
			'position': 'absolute',
			'top': '100px',
			'left': '-51px',
		...
		this.flame = new __WEBPACK_IMPORTED_MODULE_3__Flame__["a" /* Flame */]('flame');
		this.flame.show();
	...
	setShip() {
		__WEBPACK_IMPORTED_MODULE_0_gsap__["d" /* TweenMax */].set(this.el, { top: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).height() - this.height, left: '40%' });
	}
	...
	createGrid() {
		...
		var offset = 200;
		var counter = 0;
		var grid = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div id="GRID"></div>').attr({ 'height': $this.gridH }).css({ 'width': '100%', 'height': '100%', 'padding': '0%', 'box-sizing': 'border-box' });

		var grid_container = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div class="GRID_CONTAINER"></div>').css({ 'position': 'relative' });
		grid.append(grid_container);
		this.container.append(grid);
	}

	createEnemy() {
		new __WEBPACK_IMPORTED_MODULE_4__Enemy__["a" /* Enemy */]({ container: this.container, text: this.keywords.words.randomElement() });
	}
	...
	moveShip(direction) {
		...
		if (this.direction === 'still') {
			this.speed = 0;
			__WEBPACK_IMPORTED_MODULE_0_gsap__["d" /* TweenMax */].to(this.el, 1, { rotation: '0' });
		}
		...
		// LEFT
				...
				__WEBPACK_IMPORTED_MODULE_0_gsap__["d" /* TweenMax */].to(this.el, 1, { rotation: '-45deg' });
			}
	...
	takeOff() {
		...
		// Tweenmax version
		var tl = new __WEBPACK_IMPORTED_MODULE_0_gsap__["c" /* TimelineMax */]({ onComplete: function () {} });

		tl.addLabel('BEGIN')

		// STRAIGHLINE
		.to([__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.arrow'), __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#SpaceBar')], 1, { opacity: 0 }).to(this.el, 1, { scaleY: 0.75 }, 'BEGIN').addLabel('SPRING').add(function () {
			$this.dark();
		})
		// INITIAL SPRING JUMP
		.to(this.el, 1, { scaleY: 1.25 }, 'SPRING').to(this.el, 1, { scaleY: 1 }).to(this.el, 2, { top: 0 - this.height + 200 }, 'SPRING')
		// TURN SCREEN TO BLACK
		.addLabel('PITCH_BLACK').add(function () {
			$this.darker();
		}, 'PITCH_BLACK -=1.5').to('.props', 2, { top: $this.getwinH() }, 'PITCH_BLACK -=2').to(this.el, 3, { top: '70%', scaleY: 1, ease: __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* Sine */].easeOut }).add(function () {
	...
	getwinH(e) {
		return __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).height();
	}

	getwinW(e) {
		return __WEBPACK_IMPORTED_MODULE_1_jquery___default()(window).width();
	}
...
Granim.prototype.animateColors = __webpack_require__(22);
Granim.prototype.changeBlendingMode = __webpack_require__(23);
Granim.prototype.changeDirection = __webpack_require__(24);
Granim.prototype.changeState = __webpack_require__(25);
Granim.prototype.clear = __webpack_require__(26);
Granim.prototype.convertColorToRgba = __webpack_require__(27);
Granim.prototype.destroy = __webpack_require__(28);
Granim.prototype.eventPolyfill = __webpack_require__(29);
Granim.prototype.getColor = __webpack_require__(30);
Granim.prototype.getColorDiff = __webpack_require__(31);
Granim.prototype.getColorPos = __webpack_require__(32);
Granim.prototype.getColorPosDiff = __webpack_require__(33);
Granim.prototype.getCurrentColors = __webpack_require__(34);
Granim.prototype.getCurrentColorsPos = __webpack_require__(35);
Granim.prototype.getDimensions = __webpack_require__(36);
Granim.prototype.getElement = __webpack_require__(37);
Granim.prototype.getLightness = __webpack_require__(38);
Granim.prototype.makeGradient = __webpack_require__(39);
Granim.prototype.onResize = __webpack_require__(40);
Granim.prototype.onScroll = __webpack_require__(41);
Granim.prototype.pause = __webpack_require__(42);
Granim.prototype.pauseWhenNotInView = __webpack_require__(43);
Granim.prototype.play = __webpack_require__(44);
Granim.prototype.prepareImage = __webpack_require__(45);
Granim.prototype.refreshColorsAndPos = __webpack_require__(46);
Granim.prototype.setColors = __webpack_require__(47);
Granim.prototype.setDirection = __webpack_require__(48);
Granim.prototype.setSizeAttributes = __webpack_require__(49);
Granim.prototype.triggerError = __webpack_require__(50);
Granim.prototype.validateInput = __webpack_require__(51);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Flame; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
...
class Flame {
	...
	hide() {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + this.el).hide();
	}

	show() {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + this.el).show();
	}
}
...
class Enemy {
	constructor(obj) {
		...
		this.ship = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.SHIP');
	...
	create() {
		...
		var $this = this;
		this.el = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div class="ENEMY"></div>').css({ 'position': 'absolute', 'left': this.left, top: this.top }).css({ 'background': 'white', 'width': this.width, 'height': this.height });
		...
		__WEBPACK_IMPORTED_MODULE_1_gsap__["d" /* TweenMax */].to(this.el, 10, { top: __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).height(), onUpdate: doSomething, onComplete: destroy });
	...
	randomLeft() {
		...
		return getRandomInt(0, __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).width());
	}
...
/* WEBPACK VAR INJECTION */(function(global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function (a, b) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (b(a)),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == typeof exports ? module.exports = b(a) : a.inlineSVG = b(a);
  ...
  var b,
    ...
    var a = {},
        b = !1,
        c = 0,
        d = arguments.length;"[object Boolean]" === Object.prototype.toString.call(arguments[0]) && (b = arguments[0], c++);for (var e = function (c) {
      ...
      h = function () {
    var a = document.querySelectorAll(b.svgSelector);return a;
  },
      i = function (a) {
    var c = h(),
        d = f(c.length, a);Array.prototype.forEach.call(c, function (a, c) {
      var e = a.src || a.getAttribute("data-src"),
          f = a.attributes,
          g = new XMLHttpRequest();g.open("GET", e, !0), g.onload = function () {
        if (g.status >= 200 && g.status < 400) {
          var c = new DOMParser(),
              e = c.parseFromString(g.responseText, "text/xml"),
              h = e.getElementsByTagName("svg")[0];if (h.removeAttribute("xmlns:a"), h.removeAttribute("width"), h.removeAttribute("height"), h.removeAttribute("x"), h.removeAttribute("y"), h.removeAttribute("enable-background"), h.removeAttribute("xmlns:xlink"), h.removeAttribute("xml:space"), h.removeAttribute("version"), Array.prototype.slice.call(f).forEach(function (a) {
            ...
            var i = document.createElementNS("http://www.w3.org/2000/svg", "desc"),
                j = document.createTextNode(f.longdesc.value);i.appendChild(j), h.insertBefore(i, h.firstChild);
          }if (f.alt) {
            h.setAttribute("aria-labelledby", "title");var k = document.createElementNS("http://www.w3.org/2000/svg", "title"),
                l = document.createTextNode(f.alt.value);k.appendChild(l), h.insertBefore(k, h.firstChild);
